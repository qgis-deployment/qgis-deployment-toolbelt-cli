...
```sh
sphinx-autobuild -b html docs/ docs/_autobuild/ --delay 3 --open-browser --ignore docs/_apidoc --ignore docs/misc/dependencies.md --ignore docs/reference/rules_context.json --ignore docs/usage/download_section.md --ignore docs/commands-index.rst --watch qgis_deployment_toolbelt
```
