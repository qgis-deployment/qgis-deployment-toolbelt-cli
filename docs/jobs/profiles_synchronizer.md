...
3. **Overwrite the temporary INI** with the currently installed one. The temp directory now holds the user's existing settings.
...
5. **Copy the merged result** back into the QGIS profiles folder.
